...
$(function() {
    ...
    $.fn.stepy.defaults.backLabel = '<i class="icon-arrow-left13 position-left"></i> Quay lại';
    $.fn.stepy.defaults.nextLabel = 'Tiếp theo <i class="icon-arrow-right14 position-right"></i>';
